...
apply(m,1,max) # gives maximum of each row of m
...
L=list(element1=1:2,x) # creates a list that consists of two elements also
...
for(i in 1:100) { # does 100 times:
v[i]=mean(sample(1:100,25)) } # take a sample of size 25 out of 1,..., 100 and
                              # compute sample mean and store in v
#
##plotting
#
...
col="red", lty=2)    # with dashed, red lines
